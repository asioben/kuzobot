module.exports.run = async (client, message, args) => {
    ...
    if(message.member.hasPermission("ADMINISTRATOR")) {
        ...
        if(db.get("antibot_" + message.guild.id) !== "on") return message.channel.send(`**${emojis.non} L'anti bot n'est pas activé.**`)
...
module.exports.help = {
    ...
    category: "antiraid",
    enabled: true,
    description: "Permet de désactiver le système d'anti bot."
};